...
// import { Container, Row, Col, Navbar, Form, FormControl, Button, Card, Dropdown } from "react-bootstrap";
...
//           <FormControl type="search" placeholder="Search Games" className="me-2" />
...
//                   <Card>
//                     <Card.Img variant="top" src="/image/gameimg.webp" />
//                     <Card.Body>
//                       <Card.Title>Game Title</Card.Title>
//                       <Card.Text>Category: {category} | Tag: {tag} | Rating: ⭐⭐⭐⭐</Card.Text>
//                     </Card.Body>
//                   </Card>
//                 </Col>
//               ))}
...
// const App = () => {
//   // State for category and tag filters, and game data
//   const [category, setCategory] = useState("All");
//   const [tag, setTag] = useState("All");
//   const [games, setGames] = useState([]);
//   const [loading, setLoading] = useState(true);

//   // Fetch games based on category and tag filters
//   useEffect(() => {
...
//           `https://api.rawg.io/api/games?key=${apiKey}${categoryQuery}${tagQuery}`
//         );
...
//     fetchGames();
//   }, [category, tag]); // Re-run the effect when category or tag changes
...
// const App = () => {
//   // State for category and tag filters, game data, pagination
//   const [category, setCategory] = useState("All");
//   const [tag, setTag] = useState("All");
//   const [games, setGames] = useState([]);
//   const [loading, setLoading] = useState(true);
...
//   // Fetch games based on category, tag, and current page
//   useEffect(() => {
//     const fetchGames = async () => {
//       setLoading(true);
//       try {
...
//         const response = await axios.get(
//           `https://api.rawg.io/api/games?key=${apiKey}${categoryQuery}${tagQuery}${pageQuery}`
//         );
...
//     fetchGames();
//   }, [category, tag, currentPage]); // Re-run the effect when category, tag, or page changes
...
//     const pageEnd = Math.min(pageStart + 19, totalPages);
